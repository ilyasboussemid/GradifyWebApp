package com.gradify.offer.sparql;
...
/**
 * Client SPARQL HTTP — envoie des requêtes SELECT à Fuseki
 * et parse les résultats JSON.
 */
@Component
public class SparqlClient {
    ...
    /**
     * Exécute une requête SELECT et retourne une liste de maps.
     */

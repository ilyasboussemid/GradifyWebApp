...
/**
 * Service des offres de stage — construit et exécute les requêtes SPARQL.
 */
@Service
public class OfferService {
    ...
    /**
     * Recherche d'offres avec filtres optionnels.
     */
    public Map<String, Object> search(String skill, String company, String program, String city, int page, int size) {
        ...
        // Enrichir avec les skills pour chaque offre
    ...
    /**
     * Récupère les filtres disponibles (skills, villes, entreprises, programmes).
     */

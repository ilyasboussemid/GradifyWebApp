          ...
          {user ? (
            <>
              <span className="flex items-center gap-1" style={{ fontSize: '0.8rem', color: 'var(--muted)' }}>
                ...
                {user.role === 'ENTERPRISE' && <FiUser style={{ color: 'var(--accent)' }} />}
              ...
              <Button variant="ghost" size="sm" onClick={handleLogout} icon={<FiLogOut />}>
                Déconnexion
              </Button>
            </>
          ) : (
            <>
              ...
              <Button variant="primary" size="sm" onClick={() => navigate('/offres')}>
                Explorer les offres
              </Button>
            </>
          )}

...
import { FiShield, FiActivity, FiDatabase, FiAlertTriangle, FiCheckCircle, FiClock } from 'react-icons/fi';
    ...
    <div>
      ...
      <div className="container" style={{ paddingBottom: '3rem' }}>
        <div className="grid grid-4" style={{ marginBottom: '2rem' }}>
          <StatCard icon={<FiCheckCircle />} value={shaclSummary?.conforming || 0} label="Shapes conformes" />
          <StatCard icon={<FiAlertTriangle />} value={shaclSummary?.warnings || 0} label="Avertissements" />
          <StatCard icon={<FiShield />} value={shaclSummary?.violations || 0} label="Violations SHACL" />
          <StatCard icon={<FiActivity />} value={logs.length} label="Requêtes récentes" />
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '2rem', alignItems: 'start' }}>
          <div className="flex flex-col gap-3">
            ...
            <Card variant="flat">
              ...
              <Table columns={logColumns} data={logs} emptyMessage="Aucun log disponible" />
            </Card>
          </div>

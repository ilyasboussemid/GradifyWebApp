package com.gradify.matching.sparql;
...
public class SparqlClient {
    @Value("${sparql.endpoint}") private String endpoint;
    ...
    public List<Map<String, String>> query(String sparql) {
        ...
        body.add("query", PREFIXES + sparql);
        ...
        try {
            ...
            List<Map<String, Object>> bindings = (List<Map<String, Object>>) ((Map<String, Object>) data.get("results")).get("bindings");
            List<Map<String, String>> output = new ArrayList<>();
            for (Map<String, Object> row : bindings) {
                Map<String, String> parsed = new HashMap<>();
                for (Map.Entry<String, Object> e : row.entrySet()) {
                    parsed.put(e.getKey(), ((Map<String, String>) e.getValue()).get("value"));
                }
                output.add(parsed);
            }
            return output;

...
/**
 * Contrôleur Admin — SHACL reports et logs d'accès.
 * Protégé par JWT + rôle ADMIN au niveau du gateway.
 */
@RestController
...
public class AdminController {
    ...
    /**
     * GET /api/admin/shacl/report — Rapport de conformité SHACL
     */
    @GetMapping("/shacl/report")
    public ResponseEntity<?> getShaclReport() {
        // Dans un vrai système, cela exécuterait pyshacl ou lirait un cache
    ...
    /**
     * GET /api/admin/logs — Logs d'accès récents
     */
    @GetMapping("/logs")
    public ResponseEntity<?> getLogs(
        ...
        // En production, ces logs viendraient d'une DB ou d'un fichier
